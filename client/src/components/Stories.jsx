                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        <div className="lg:pr-8 lg:pt-4">
                            <div className="lg:max-w-lg">
                                <h2 className="text-base font-semibold leading-7 text-sky-600">Why Invest in Lucknow?</h2>
                                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">The Future AI City</p>
                                <p className="mt-6 text-lg leading-8 text-gray-600">
                                    Lucknow is poised to become the first AI city, attracting top universities like Chandigarh University. This makes it a prime location for various investments.
                                </p>
                                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                    <div className="relative pl-9">
                                        <dt className="inline font-semibold text-gray-900">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" className="absolute left-1 top-1 h-5 w-5 text-sky-600">
                                        ...
                                        <dd className="inline">Lucknow's transformation into an AI city is underway, making it an attractive spot for tech investments.</dd>
                                    </div>
                                    <div className="relative pl-9">
                                        <dt className="inline font-semibold text-gray-900">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" className="absolute left-1 top-1 h-5 w-5 text-sky-600">
                                        ...
                                        <dd className="inline">Institutions like Chandigarh University are setting up campuses in Lucknow, enhancing its educational landscape.</dd>
                                    </div>
                                    <div className="relative pl-9">
                                        <dt className="inline font-semibold text-gray-900">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" className="absolute left-1 top-1 h-5 w-5 text-sky-600">
                                        ...
                                        <dd className="inline">The city's growth offers great potential for investments in farmhouses, hostels, flats, and restaurants.</dd>
                                    </div>
                                </dl>
                            </div>
                        
                        </div>
                        <img src={lucknow} alt="Product screenshot" style={{objectFit:"contain"}} className="w-[48rem] lg:mt-20 rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0" width="2432" height="1442" />
                    </div>
                </div>
            </section>
        </div>

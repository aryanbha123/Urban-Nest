            ...
            <section  className="container mx-auto px-6 p-10">
                ...
                <div className="flex items-center flex-wrap mb-20">
                    ...
                    <div className="w-full md:w-1/2">
                        <img className="rounded-lg" src="https://example.com/mission.jpg" alt="Our Mission" />
                    </div>
                </div>
                <div className="flex items-center flex-wrap mb-20">
                    <div className="w-full md:w-1/2">
                        <img className="rounded-lg" src="https://example.com/values.jpg" alt="Our Values" />
                    </div>
                    <div className="w-full md:w-1/2 pl-10">
                        <h4 className="text-3xl text-gray-800 font-bold mb-3">Our Values</h4>
                        <p className="text-gray-600 mb-8">We believe in integrity, transparency, and commitment. Our values guide us in every interaction and transaction, ensuring that we build trust and long-lasting relationships with our clients and partners.</p>
                    </div>
                </div>
                <div className="flex items-center flex-wrap mb-20">
                    <div className="w-full md:w-1/2 pr-10">
                    ...
                    <div className="w-full md:w-1/2">
                        <img className="rounded-lg" src="https://example.com/team.jpg" alt="Our Team" />
                    </div>
                </div>
            </section>
        </div>

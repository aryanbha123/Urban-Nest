            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                ...
                <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    ...
                    <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                        <span className="relative inline-block">
                            ...
                            <span className="relative mr-3">Discover</span>
                        </span>
                        why investing in Dehradun & Lucknow is a smart choice
                    </h2>
                    <p className="text-base text-gray-700 md:text-lg">Explore the benefits of investing in two of India's fastest-growing cities and why they are prime locations for real estate, business, and lifestyle opportunities.</p>
                </div>
                ...
                <div className="grid max-w-md gap-8 row-gap-10 sm:mx-auto lg:max-w-full lg:grid-cols-3">
                    ...
                    <div className="flex flex-col sm:flex-row">
                        ...
                        <div>
                            <h6 className="mb-2 font-semibold leading-5">Lucknow: City of Nawabs</h6>
                            <p className="mb-3 text-sm text-gray-900">
                                As the capital of Uttar Pradesh, Lucknow offers a blend of cultural heritage and modern infrastructure, making it a lucrative investment destination.
                            </p>
                    ...
                    <div className="flex flex-col sm:flex-row">
                        ...
                        <div>
                            ...
                            <p className="mb-3 text-sm text-gray-900">
                                Both cities are experiencing rapid growth in various sectors, providing ample opportunities for investors to reap significant returns.
                            </p>
                            <ul className="mb-4 -ml-1 space-y-2">
                                <li className="flex items-start">
                                    <span className="mr-1">

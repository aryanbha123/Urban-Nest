...
import dehradun from '../assets/dehradun.png';
      ...
      <section className="overflow-hidden bg-white py-8 sm:py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <img 
              src={dehradun} 
              alt="Dehradun scenery" 
              style={{ objectFit: "contain" }} 
              className="w-[48rem] lg:mt-20 rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-mr-4 lg:-mr-2" 
              width="2432" 
              height="1442" 
            />
              ...
              <div className="lg:max-w-lg">
                ...
                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                  <div className="relative pl-9">
                    ...
                    <dd className="inline">Dehradun is becoming a central hub for universities, offering a rich educational environment.</dd>
                  </div>
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      <svg 
                    ...
                    <dd className="inline">Known for its scenic beauty, Dehradun attracts tourists, making it a great spot for hospitality investments.</dd>
                  </div>
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      <svg 
                    ...
                    <dd className="inline">Dehradun presents great investment opportunities in hostels, hotels, flats, and farmhouses.</dd>
                  </div>
                </dl>
              </div>
            </div>
